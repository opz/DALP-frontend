        ...
        <div className="container">
          <section id="hero" className="row">
            <div className="col-md-5">
              ...
              <h4>DALP will automatically move your funds to liquidity pools that earn you the highest fees. Simply swap your ETH for DALP tokens, and start earning interest.</h4>
            </div>
          ...
          <section className="row">
            <div className="col-md-12 text-center">
              <h3 className="section-header">We integrate with leading liquidity pools.</h3>
            </div>
